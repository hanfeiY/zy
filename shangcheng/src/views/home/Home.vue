<template>
    <div>
        <el-page-header icon="" title="中药商店">
            <template #content>
...
const avatarUrl = computed(()=>store.state.userInfo.avatar?'http://localhost:3000'+store.
state.userInfo.avatar:`https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png`
);
const welcomeText = computed(()=>new Date().getHours()<12?'要开心每一天.':'来片薄荷提提神吧')
