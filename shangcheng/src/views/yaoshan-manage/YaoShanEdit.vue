    ...
    <div>
        ...
        <el-form
            ...
            <el-form-item label="内容" prop="content">
                <editor @event="handleChange1" :content="yaoshanForm.content" 
                v-if="showEdit"/>
            </el-form-item>
...
onMounted(async()=>{
    ...
    const res = await axios.get(`/adminapi/yaoshan/list/${route.params.id}`)
    // console.log(res.data.data[0])
    if(res.data.data.length>0){
        Object.assign(yaoshanForm,res.data.data[0]);
        showEdit.value = true;
    }
