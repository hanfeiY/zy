    ...
    <el-row>
        <el-col :span="17" :offset="1">
            <div>
                ...
                <div class="time">
                    <h4>{{ whichTime(currentProduct.editTime) }}</h4>
                </div>
             ...
             <el-card style="max-width: 480px">
                <template #header>
                    <div class="card-header">
                        <span style="font-size:16px;font-weight:bold">最新发布药书</span>
                    </div>
                </template>
                    <div 
...
watchEffect(async()=>{
    ...
    const res2 = await axios.get(`/webapi/product/toplist?limit=4`)
